...
import com.anmol.web_client_lib.filters.HeadersWebClientFilterFunction
import com.anmol.web_client_lib.filters.WebClientLoggingFilter
...
class WebClientBuilderConfiguration {
    ...
    private final val connectionProvider = ConnectionProvider.builder("custom")
        .maxConnections(100)
    ...
    fun httpTraceRepository(): HttpExchangeRepository {
        return AccessLoggingTraceRepository()
    }
